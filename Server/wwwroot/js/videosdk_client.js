...
let camButton;
let copy_meeting_id;
let contentRaiseHand;
let btnScreenShare;
let videoScreenShare;
let btnRaiseHand;
...
//recording
let btnStartRecording;
let btnStopRecording;
...
// For PreCall
let cameraDeviceDropDown;
let microphoneDeviceDropDown;
let playBackDeviceDropDown;
let joinMeetingCode;
let joiningName;
let refreshButton;
let networkErrorRefreshButton;
...
async function initializeVideoSDK() {
    ...
    cameraDeviceDropDown = document.getElementById('cameraDeviceDropDown');
    microphoneDeviceDropDown = document.getElementById('microphoneDeviceDropDown');
    playBackDeviceDropDown = document.getElementById('playBackDeviceDropDown');
    joinMeetingCode = document.getElementById("joinMeetingId");
    joiningName = document.getElementById("name");
    refreshButton = document.getElementById("refresh");
    networkErrorRefreshButton = document.querySelectorAll(".network-error-refresh");
    microphonePermission = document.getElementById("no-microphone-permission");
    cameraPermission = document.getElementById("no-camera-permission");
...
function addParticipantToList({ id, displayName }) {
    ...
    participantTemplate.style.backgroundColor = "var(--rz-primary-light)";
...
async function joinMeeting(newMeeting) {
    ...
    if (meetingId!="") {
        joinMeetingCodeValue = meetingId;
    }
    if (!newMeeting) {
