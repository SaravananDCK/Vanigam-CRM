...
(function ($) {
    $.widget('ui.slider', $.ui.mouse, {
        ...
        _stop: function (event, index) {
            ...
            //this.options.dotNetHelper.invokeMethod('UpdateValue', uiHash.value, uiHash.values.indexOf(uiHash.value))
            this.options.dotNetHelper.invokeMethodAsync('UpdateValue', uiHash.value, uiHash.values.indexOf(uiHash.value))
            //$(this.handles).removeClass('ui-state-active');
