...
namespace Vanigam.CRM.Client.Pages.ListView
{
    public partial class InventoryItems
    {
        protected async Task GridLoadData(LoadDataArgs args)
        {
            try
            {
                var result = await InventoryItemApiService.Get(filter: GetFilterString(args),expand:GetExpandString(args), orderBy: $"{args.OrderBy}", top: args.Top, skip: args.Skip, count:args.Top != null && args.Skip != null);
