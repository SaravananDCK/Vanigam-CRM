...
namespace Vanigam.CRM.Client.Pages.ListView
{
    public partial class GPSPoints
    {
        ...
        {
            await DialogService.OpenDialogAsync<EditGPSPoint>(Localizer["AddGPSPoint"], null, 100, 100);
            await GridReload();
        }
        ...
        {
            await DialogService.OpenDialogAsync<EditGPSPoint>(Localizer["EditGPSPoint"], new Dictionary<string, object> { { "Oid", gpspoint.Oid } }, 100, 100);
            await GridReload();
        }
