...
namespace Vanigam.CRM.Client.Pages.ListView
{
    public partial class ReportTemplates
    {
        ...
        {
            await DialogService.OpenDialogAsync<EditReportTemplate>(Localizer["AddReportTemplate"], null, 100, 100);
            await GridReload();
        }
        ...
        {
            await DialogService.OpenDialogAsync<EditReportTemplate>(Localizer["EditReportTemplate"], new Dictionary<string, object> { { "Oid", reporttemplate.Oid } }, 100, 100);
            await GridReload();
        }
