...
namespace Vanigam.CRM.Client.Pages.ListView
{
    public partial class Products
    {
        protected async Task GridLoadData(LoadDataArgs args)
        {
            try
            {
                var result = await ProductApiService.Get(filter: GetFilterString(args), orderBy: $"{args.OrderBy}", top: args.Top, skip: args.Skip, count:args.Top != null && args.Skip != null);
