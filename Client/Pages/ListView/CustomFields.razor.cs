...
namespace Vanigam.CRM.Client.Pages.ListView
{
    public partial class CustomFields
    {
        ...
        {
            await DialogService.OpenDialogAsync<EditCustomField>(Localizer["AddCustomField"], null, 100, 100);
            await GridReload();
        }
        ...
        {
            await DialogService.OpenDialogAsync<EditCustomField>(Localizer["EditCustomField"], new Dictionary<string, object> { { "Oid", customfield.Oid } }, 100, 100);
            await GridReload();
        }
