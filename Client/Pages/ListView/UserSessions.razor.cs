...
namespace Vanigam.CRM.Client.Pages.ListView
{
    public partial class UserSessions
    {
        ...
        {
            await DialogService.OpenDialogAsync<EditUserSession>(Localizer["AddUserSession"], null, 100, 100);
            await GridReload();
        }
        ...
        {
            await DialogService.OpenDialogAsync<EditUserSession>(Localizer["EditUserSession"], new Dictionary<string, object> { { "Oid", usersession.Oid } }, 100, 100);
            await GridReload();
        }
