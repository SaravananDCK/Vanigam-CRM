...
public class LeadDropDownDataGrid : VanigamAccountingDropDownAddDataGrid<Lead, EditLead>
{
    [Inject] LeadApiService LeadApiService { get; set; }
    public LeadDropDownDataGrid()
    {
        Name = "cbx_LeadId";
    }
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        this.Columns = (builder2) =>
        {
            ...
            builder2.AddAttribute(1, "Property", nameof(Lead.Name));
